...
-- CreateEnum
CREATE TYPE "ProductUnit" AS ENUM ('KG', 'GRAM', 'PIECE', 'BOX');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'UPI', 'COD', 'WALLET');

-- CreateEnum
CREATE TYPE "ModerationStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_UPDATE', 'PROMOTION', 'REVIEW', 'GENERAL');
...
-- CreateIndex
CREATE INDEX "Product_averageRating_isActive_idx" ON "Product"("averageRating", "isActive");
